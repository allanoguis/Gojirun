...
export const GameService = {
    ...
    async getProfileData(userId) {
        ...
        // Use the profile view to bypass RLS policies and get all data in one query
        ...
        console.log('Profile view query result:', { profileData, profileError });

        if (profileError) {
            console.error('Profile view error:', profileError);
            throw profileError;
        }

        // If Guest user not found, create a placeholder record
        if (userId === '000000' && !profileData) {
            ...
            // Return default profile for newly created guest
            return {
                user: newGuest,
                highScore: 0,
                pastGames: []
        ...
        const result = {
            ...
            highScore: profileData?.high_score || 0,
            pastGames: profileData?.past_games || []
        };

        console.log('getProfileData returning:', result);
        return result;
    },
