...
/**
 * Fetch the leaderboard. Uses the same data source everywhere when
 * NEXT_PUBLIC_LEADERBOARD_API_URL is set (e.g. to production API) so local and production show the same list.
 */
